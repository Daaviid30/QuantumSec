...
Puertas de calidad verificadas tras PQC Fase 3: 461 tests Python pasando, Ruff limpio y Pyright sin errores. La interfaz no cambió en esta fase; su última validación registrada mantiene 6 tests Vitest pasando.