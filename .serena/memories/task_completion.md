...
Puertas de calidad verificadas tras la revisión de PQC Fase 6: 545 tests Python pasando, Ruff limpio y Pyright sin errores. La interfaz no cambió en esta fase; su última validación registrada mantiene 6 tests Vitest pasando.
