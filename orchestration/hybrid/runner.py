...
def run_hybrid_session(config: SessionConfig, context: SessionExecutionContext) -> SessionResult:
    ...
    try:
        ...
        qkd_metrics = QKDSessionMetrics(
            ...
            estimated_z_errors=qkd_result.qkd.estimated_z_errors,
            estimated_z_trials=qkd_result.qkd.estimated_z_trials,
            estimated_x_errors=qkd_result.qkd.estimated_x_errors,
            estimated_x_trials=qkd_result.qkd.estimated_x_trials,
            estimated_aggregate_errors=qkd_result.qkd.estimated_aggregate_errors,
            estimated_aggregate_trials=qkd_result.qkd.estimated_aggregate_trials,
